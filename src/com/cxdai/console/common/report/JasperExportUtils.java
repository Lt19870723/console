...
public class JasperExportUtils {
	 ...
	 * 导出excel
	 */
	public static void exportExcel(JasperPrint jasperPrint, HttpServletRequest request, HttpServletResponse response, String filename) throws IOException, JRException {
		/*
		 * 设置头信息
		 */
	 ...
	 * UniGB-UCS2-H
	 */
	public static void exportPdf(JasperPrint jasperPrint, HttpServletRequest request, HttpServletResponse response, String filename) throws IOException, JRException {
		if (null == filename || "".equals(filename)) {
			filename = "未命名";
		}
	 ...
	 * 导出word
	 */
	public static void exportWord(JasperPrint jasperPrint, HttpServletRequest request, HttpServletResponse response) throws JRException, IOException {
	 ...
	 * 打印
	 */
	public static void exportPrint(JasperPrint jasperPrint, HttpServletResponse response, HttpServletRequest request) throws IOException {
	 ...
	 * @param response
	 */
	public static void export(Collection datas, Map parameters, String type, InputStream is, HttpServletRequest request, HttpServletResponse response, String filename) {
		try {
