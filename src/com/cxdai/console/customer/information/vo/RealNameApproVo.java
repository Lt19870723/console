...
public class RealNameApproVo implements Serializable {
	...
	public String getAppTimeStr() {
		if (null != appTime) {
			return DateUtils.timeStampToDate(appTime, DateUtils.YMD_DASH);
		}
		return appTimeStr;
	}
	...
	public int getFinancialUser() {
		return financialUser;
	}

	public void setFinancialUser(int financialUser) {
