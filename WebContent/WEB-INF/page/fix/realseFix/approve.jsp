	...
	<form action="" id="firstAddform" style="background: #fff;">
	 ...
	 <table style="width:800px;  margin:20 auto;  position:relative;  float:none;  padding:0;  text-align:left;" border="1">
		<tr>
			...
			<td><input type="text" value="${fixBorrowVo.planAccount/10000}"disabled="true" name="planAccount" id="planAccount" maxlength="12" onblur="getDefaultKted(this.value)"
				style="width: 160px;"	size="20"/>&nbsp;万元
			</td>		
				
			<td width="100px">锁定期限：<font color="red">*</font></td>
			<td>
				<select id="lockLimit" name="lockLimit" disabled="true" onchange="getDefaultYqsy(this.value)" style="height:24px;width:199px">
		...
		<tr>
			...
			<td><input type="text" value="${fixBorrowVo.apr}" disabled="true" id="apr" name="apr" maxlength="50"  
			...
			<td><input type="text" value="${fixBorrowVo.mostAccount/10000}" name="mostAccount" id="mostAccount" disabled="true" maxlength="12"
			style="width: 160px;"	size="20"/>&nbsp;万元
			</td>					
		<td width="100px">定时开通时间：<font color="red">*</font></td>
			<td>
				...
				<input type="text" disabled="true"  name="publishTime" id="publishTime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:00'})"
		...
		<tr>
			...
			<td colspan="4" height="80px;">
				...
				<input type="radio" name="validTime_style" disabled="true" value="1" ${fixBorrowVo.validTimeStyle==1?'checked=checked':''}  />按天&nbsp;
				<input type="radio" name="validTime_style" disabled="true" value="2" ${fixBorrowVo.validTimeStyle==2?'checked=checked':''}   />按小时&nbsp;
				<input type="radio" name="validTime_style" disabled="true" value="3" ${fixBorrowVo.validTimeStyle==3?'checked=checked':''}   />按分钟&nbsp;
				<input type="text" value="${fixBorrowVo.validTime}" maxlength="5"  disabled="true"
			      size="20" id="validTime" name="validTime"  style="width:80px;"/>
		...
		<tr>
			<td colspan="4" align="center"> 
				&nbsp;
				<input type="button" onclick="cancle()"   name="Submit1"
					id="subbtn" class="b_buts" value="关 闭" />
				<input type="button" onclick="submitApprove()"   name="Submit1"
					id="comfirm" class="b_buts" value="确认提交审核" /> 				
			</td>						
		</tr>																																	
	</table>
	</form> 
...
function submitApprove(){
	...
	$("#firstAddform").ajaxSubmit ({
		url : '${path}/fix/realseFix/submitApprove.html',
		type : 'post',
		dataType : 'json',
