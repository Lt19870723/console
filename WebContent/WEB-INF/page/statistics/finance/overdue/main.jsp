...
<script type="text/javascript">
	...
	*/
	function pageGo(pageNo) {
		...
		var urlPath = '${path}/statistics/finance/overdueinfo/list/' + pageNo + '.html';
	...
	*/
	...
	function validateExportDataCount(){
		$("#queryForm").ajaxSubmit ({
			url : '${path}/statistics/finance/overdueinfo/overduecount.html',
			type : 'post' ,
			dataType : 'json',
			success : function(result) {
				if(result.code == '0'){
	 ...
	 */
	function exportData(){
		$("#queryForm").attr("action","${path}/statistics/finance/overdueinfo/overdueexport.html");
        $("#queryForm").submit();
	}
	/**
	 *校验导出数据的过滤条件
