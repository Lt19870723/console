...
<body style="background: #f9f9f9;">
	<form id="queryForm" action="" method="post">
		...
		<div id="loginLogCard" style="margin-left:20px;line-height:50px;">
			&nbsp;
			应还时间：<input name="repaymentTimeBegin" id="repaymentTimeBeginStr" onclick="WdatePicker()" styleClass="Wdate" ></input>
			至
			<input name="repaymentTimeEnd" id="repaymentTimeEndStr" onclick="WdatePicker()" styleClass="Wdate"></input>
			&nbsp;	
			 <input type="button"
...
<script type="text/javascript">
	...
	*/
	function pageGo(pageNo) {
		...
		var urlPath = '${path}/statistics/finance/week/list/' + pageNo + '.html';
	...
	*/
	...
	function validateExportDataCount(){
		$("#queryForm").ajaxSubmit ({
			url : '${path}/statistics/finance/week/weekcount.html',
			type : 'post' ,
			dataType : 'json',
			success : function(result) {
				if(result.code == '0'){
	 ...
	 */
	function exportData(){
		$("#queryForm").attr("action","${path}/statistics/finance/week/weekexport.html");
        $("#queryForm").submit();
	}
	/**
	 *校验导出数据的过滤条件
