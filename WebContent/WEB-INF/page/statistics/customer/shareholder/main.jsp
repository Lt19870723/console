...
<body style="background: #f9f9f9;">
	<form id="queryForm" action="" method="post" style="width: 100%;">
		...
		<div id="loginLogCard" style="margin-left:20px;line-height:50px;">
			...
			真实姓名:<input id="realname" name="realname" class="input1" style="width:150px;"/>
			&nbsp;	
			 <input type="button"
...
<script type="text/javascript">
	...
	*/
	function pageGo(pageNo) {
		...
		var urlPath = '${path}/customer/shareholdercount/list/' + pageNo + '.html';
	...
	*/
	...
	function showshareholder(id){
		var _url = '${path}/customer/shareholdercount/findShareholder/'+id+'.html';
		$.layer({
		type : 2,
		title : '转可提',
		area : [ '800px', '300px' ],
