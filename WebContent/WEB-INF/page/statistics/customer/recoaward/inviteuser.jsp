...
<body style="background: #f9f9f9;">
	<form id="approForm" action="" method="post">
		<table align="center" border="1" bordercolor="black" style="width: 95%">
			<tr>
				<td colspan="2">直接推荐共享奖明细(统计日期:${year}-${invetedUserVo.month })</td>
				<td colspan="2">推荐人：${invetedUserVo.userName }</td>
			</tr>
			<tr>
				<td >
					序号
	...
	$.layer({
		...
		function pageGo(pageNo) {
			window.location.href='${path}/customer/recommendaward/inviteuserpagelist/${id}/${year}/'+pageNo+'.html';
		};
</script>
</html>
