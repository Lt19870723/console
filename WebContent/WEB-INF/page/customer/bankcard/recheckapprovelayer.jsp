		...
		<c:if test="${change.approveStatus != 2}">
			...
			<table width="100%" align="center" class="solidTable" border="1" bordercolor="black">
				...
				<tr>
					...
					<td colspan="3">${change.verifyVedioPath}</td>
				</tr>
			</table>
		</c:if>
		
		<c:if test="${change.approveStatus == 1}">
			<table width="100%" align="center" class="solidTable" border="1" bordercolor="black">
				<tr>
					<td align="right">复审意见：<font color="red">*</font></td>
					<td>
				...
				<tr>
					...
					<td>
						<textarea rows="5" cols="50" id="recheckRemark" name="recheckRemark" style="width:90%;height:80px;"></textarea>
					</td>
				</tr>
				<tr>
					<td></td>
...
<script type="text/javascript">
	function validForm(id,userId){
		...
		var approveRemark = $('#recheckRemark').val();
		...
		var urlPath = '${path}/bankCardChange/doRecheckApprove/'+id+'/'+userId+'.html';
