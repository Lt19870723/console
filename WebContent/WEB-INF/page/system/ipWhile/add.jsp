...
<body style="background: #f9f9f9;">
	...
	<tr>
		<td>IP白名单信息(* 必填)</td>
		<td>
		   <input id="ip" name="ip" maxlength="20" class="input1" />
		</td>
	</tr>
	<tr>
		<td>访问接口类型：</td>
	...
	<tr>
		<td>公司名称</td>
		<td>
		   <input class="input1" id="company" name="company"  maxlength="50"  />
		</td>
	</tr>
	<tr>
		<td colspan="2" align="center">
			<input type="button" onclick="javascript:add();" value="确 定" />
		</td>
	</tr>	
	</table>
