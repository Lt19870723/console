	...
	<table style="margin-left:10px;margin-top:5px;width:98%;"  border="1"  >
			<tr>
				<td  align="right"> <font color="red">*</font>词条名称：</td><td> 
                      <input type="text" id="titleForUpdate" value="${CmsPediaEntry.name }" style="width: 550px;"  maxlength="30" class="input1"/>
                      <input type="hidden" id="cmsEntryId" value="${CmsPediaEntry.id }"/>
			  </td>
			</tr>
			  <tr>
				<td align="right"><font color="red">*</font>描述：</td>
				<td>
				<textarea id="desc" name="desc" cols="80" rows="7"/>${CmsPediaEntry.desc }</textarea>
				</td>
			 </tr>
			 <tr>
				<td align="right"><font color="red">*</font>页面源代码title：</td>
				<td>
				<input type="text" id="seoTitle"  value="${CmsPediaEntry.seoTitle }" maxlength="40" style="width: 550px;"/> 
				</td>
			 </tr>
			  <tr>
				<td align="right"><font color="red">*</font>页面源代码keyword：</td>
				<td>
				<input type="text" id="seoKeywords" value="${CmsPediaEntry.seoKeywords }" maxlength="40" style="width: 550px;"/> 
				</td>
			 </tr>
			 <tr>
				<td align="right"><font color="red">*</font>页面源代码description：</td>
				<td>
				<textarea id="seoDescription" cols="80" rows="5" />${CmsPediaEntry.seoDescription }</textarea> 
				</td>
			 </tr>
			<tr>
				<td colspan="2" align="center">
					<input type="button"  id="pass" name="pass" onclick="editCmsEntry()" value="保存"/>
				</td> 
			</tr>	
		</table>
</form>
...
function editCmsEntry(){
	if(beforeChecksaveCmsPediaEntry()){
		var cmsEntryId = $('#cmsEntryId').val();
