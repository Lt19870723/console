	...
	<table style="margin-left:10px;margin-top:5px;width:98%;"  border="1"  >
					<tr>
						<td  align="right"><font color="red">*</font>标题：</td><td> 
						  <input type="text" id="titleForUpdate"  style="width: 550px;" value="${CmsArticle.title }" maxlength="30" class="input1"  onblur="changeSeoTitle()"/>
						  <input type="hidden" id="cmsSarticleId" value="${CmsArticle.id }"/>
					  </td>
					</tr>
			   ...
			   <tr>
				<td  align="right">标签：</td>
				     <td>  
						 <input type="text" id="tags" value="${CmsArticle.tags }"  style="width: 550px;"  maxlength="50" class="input1"  onblur="changeSeoKeyword()" />（如果有多个请用英文逗号“,”分隔）
				    </td>  
			   </tr>
			  ...
			  <tr>
				...
				<td>
<!-- 					<input type="file" id="upload" style="width:500px;height:60px;display: none;"/> -->
					<input type="hidden" id="thumbnail" name="thumbnail" value="${CmsArticle.thumbnail }">
					...
					<div  id="showPic"> 
						<img id="oneimageId"  width="300px"  height="120px" src="${CmsArticle.thumbnail }" />  
<!-- 						<a href="javascript:editPic()">编辑</a>  -->
			 ...
			 <tr>
				...
				<td>
				<textarea    id="content" name="content"   cols="55"  rows="7">${CmsArticle.content }</textarea>
				</td>
			 </tr>
			  ...
			  <tr>
				...
				<textarea    id="summary"  name="summary"   cols="80"  rows="7"   onblur="changeSeoDes()">${CmsArticle.summary }</textarea>
			 ...
			 <tr>
				...
				<input type="text"  value="${CmsArticle.hits }"  id="hits" />
			 ...
			 <tr>
				...
				<input type="text"  value="${CmsArticle.author }"  style="width: 550px;" id="author"  maxlength="30"  />
			 ...
			 <tr>
				...
				<td>
				<textarea id="seoTitle" maxlength="40"   style="width: 550px;" 	>${CmsArticle.seoTitle }</textarea> 
				</td>
			 </tr>
			  ...
			  <tr>
				...
				<td>
				<input type="text" id="seoKeywords" value="${CmsArticle.seoKeywords }" maxlength="40"  style="width: 550px;"	/> 
				</td>
			 </tr>
			 ...
			 <tr>
				...
				<td>
				<textarea     id="seoDescription"   cols="80"  rows="5"	>${CmsArticle.seoDescription }</textarea> 
				</td>
			 </tr>
			...
			<tr>
				<td colspan="2" align="center">
					<input type="button" id="pass" name="pass" onclick="editCmsSarticle()" value="提交"/>
				</td> 
			</tr>	
			</table> 
</form>
	...
	$.ajax({
		...
		success : function(result) {
			...
			for (var i = 0; i < data1.length-1; i++) {
				...
				if("${CmsArticle.channelId}"==data2[0]){
					$("#channelId1").append("<option selected='selected' value=\"" + data2[0] + "\">" + data2[1] + "</option>");
				}else{
...
function editCmsSarticle(){
	if(beforeChecksaveCmsArticle()){
		var cmsSarticleId = $('#cmsSarticleId').val();
