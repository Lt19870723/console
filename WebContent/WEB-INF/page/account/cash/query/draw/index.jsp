...
<body style="background: #f9f9f9;">
	<form id="queryForm" action="" method="post" style="width: 1400px;">
		...
		<div id="loginLogCard" style="margin-left:20px;line-height:50px;">
			&nbsp;
			用户：<input id="userName" name="userName"
				value="${drawableRecordCnd.userName}" class="input1" style="width:150px;"/>
			&nbsp;
			申请时间：<input
					name="beginPublicTimeStr" id="beginPublicTimeStr" onclick="WdatePicker()"
					styleClass="Wdate" value="${drawableRecordCnd.beginPublicTimeStr }">
				<f:convertDateTime pattern="yyyy-MM-dd"></f:convertDateTime>
				</input>
			至
			<input
					name="endPublicTimeStr" id="endPublicTimeStr" onclick="WdatePicker()"
					styleClass="Wdate" value="${drawableRecordCnd.endPublicTimeStr }">
				<f:convertDateTime pattern="yyyy-MM-dd"></f:convertDateTime>
				</input>
			&nbsp;	
			<select
				id="status" name="status"
				value="${drawableRecordCnd.status}"
