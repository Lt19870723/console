...
<script type="text/javascript">
	...
	*/
	function pageGo(pageNo) {
		...
		$("#queryForm").ajaxSubmit ({
			url : '${path}/borrow/autotender/autoInvesLog/list/' + pageNo + '.html',
			type : 'post',
			dataType : 'html',
	...
	*/
	...
	function fordetail(id){
		...
		var _url = '${path}/borrow/autotender/autoInvesLog/findAutoInvestConfigRecordDetail.html';
		if (id != '') {
			_url += '?id=' + id;
		}
		$.layer({
