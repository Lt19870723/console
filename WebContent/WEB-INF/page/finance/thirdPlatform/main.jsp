	...
	<form id="form" action="" method="post">
		<div style="margin-left:20px;line-height:50px;">
			<div style="margin-left:20px;line-height:50px;">
				...
				<input id="searchJournalList" name="searchJournalList" value="查询" type="button" onclick="pageGo(1);" />&nbsp;
				<input value="添加" type="button" onclick="addJournal();" />&nbsp;
...
<script type="text/javascript">
	...
	function pageGo(pageNo) {
		...
		$("#form").ajaxSubmit({
			url : '${path}/finance/thirdPlatformAccount/list/' + pageNo + '.html',
			type : 'post',
			dataType : 'html',
	...
	function addJournal() {
		var _url = "${path}/finance/thirdPlatformAccount/addOrEditJournal.html";
		$.layer({
			type : 2,
			title : '添加第三方平台日记账',
			area : [ '1000px', '400px' ],
	...
	function updateStatus(id) {
		layer.confirm("确认 删除?", function() {
			...
			$.ajax({
				url : '${path}/finance/thirdPlatformAccount/deleteJournal/' + id + '.html',
				type : 'post',
				dataType : 'json',
				success : function(result) {
					parentLayer.close(_load);
