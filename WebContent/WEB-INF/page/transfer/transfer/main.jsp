	...
	<form id="queryForm" action="" method="post" >
		<div style="margin-left:20px;line-height:50px;">
			...
			<input
				...
				class="Wdate" value="${transferCnd.beginTime}">
			</input>
			至
			<input
				name="endTime" id="endTime" onclick="WdatePicker()"
				class="Wdate" value="${transferCnd.endTime}">
			</input>
			&nbsp;					
			<input type="button"
...
<script type="text/javascript">
	...
	*/
	function pageGo(pageNo) {
		...
		var urlPath = '${path}/transfer/transfer/list/' + pageNo + '.html';
	...
	*/
	...
	function status(id) {
		var _url = '${path}/transfer/transfer/status.html';
		if (id != '') {
			_url += '?id=' + id;
		}
		$.layer({
