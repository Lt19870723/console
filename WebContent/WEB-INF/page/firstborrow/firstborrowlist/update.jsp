...
<form id="firstModifyDetailform" name="firstModifyDetailform" method="post">
	...
	<input type="hidden" id="flagFromSub" name="flagFromSub" value="Y" />
	<table style="margin-left: 10px; margin-top: 10px;">
		<tr>
			...
			<td>
				<input type="text" id="perceivedRate" name="perceivedRate" value="${firstBorrowVo.perceivedRate}" class="input1 deailtModify input_back_color" maxlength="50" size="20" readonly="readonly" />
				&nbsp;%
			</td>					
		</tr>
		<tr>
			...
			<td>
				<input type="text" id="lowestAccount" value="${firstBorrowVo.lowestAccount/10000}" class="input1 input_back_color" maxlength="12" size="20" readonly="readonly" />
				&nbsp;万元&nbsp;&nbsp;&nbsp;
			</td>
		...
		<tr>
			...
			<td>
				<input type="text" id="passwordSource" name="passwordSource" value="${firstBorrowVo.passwordSource}" class="input1 deailtModify input_back_color" maxlength="50" size="20" readonly="readonly" />
			</td>	
			...
			<td>
				...
				<input type="text"
					...
					class="input1 deailtModify input_back_color" value='<fmt:formatDate value="${firstBorrowVo.publishTime}" pattern="yyyy-MM-dd HH:mm:ss" />' readonly="readonly" />
			</td>	
		</tr>		
		<tr>
			...
			<td colspan="3" height="80px;">
				...
				<input type="radio" id="validTime_style_1" name="validTime_style" value="1" class="deailtModify" checked="checked" disabled="disabled"/>按天&nbsp;
				<input type="radio" id="validTime_style_2" name="validTime_style" value="2" class="deailtModify" disabled="disabled"/>按小时&nbsp;
				<input type="radio" id="validTime_style_3" name="validTime_style" value="3" class="deailtModify" disabled="disabled"/>按分钟&nbsp;
				<input type="text" id="validTime" name="validTime" value="${firstBorrowVo.validTime}" class="input1 deailtModify input_back_color" 
					maxlength="50" size="20" onchange="getEndTime();" style="width:80px;" readonly="readonly" />
